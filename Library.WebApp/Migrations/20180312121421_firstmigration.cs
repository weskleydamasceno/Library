    ...
    public partial class firstmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationsBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocationsBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationsBooks_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationsBooks_BookId",
                table: "LocationsBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationsBooks_LocationId",
                table: "LocationsBooks",
                column: "LocationId");
        }
